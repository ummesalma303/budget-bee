...
const Pricing = () => {
  return (
        ...
        <div className="absolute top-0 left-0 right-0 h-32">
          <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full transform rotate-180">
            <path d="M0 120L1440 120L1440 0C1440 0 1200 80 720 40C240 0 0 60 0 60L0 120Z" fill="#ffffff"/>
          </svg>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="p-8 bg-white text-slate-900 text-center transform md:scale-105 shadow-2xl">
              ...
              <div className="mb-8">
                ...
                <span className="text-slate-500 block text-sm mt-2">per month</span>
              </div>
